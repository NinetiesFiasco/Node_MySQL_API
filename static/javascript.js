    ...
    success: (response)=>{
      ...
      for (var i=0;i<data.length;i++)      
        table+= "<tr>"+
          ...
          "<td><input type='button' value='Удалить' class='deleteThisShit' data-id='"+data[i].guid+"'/></td>"+
          "<td><input type='button' value='Редактировать' class='redactThisShit' data-id='"+data[i].guid+"'/></td>"+
          "</tr>";
      table += "</table>";
      $show.html(table);
